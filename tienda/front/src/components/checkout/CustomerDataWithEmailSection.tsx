...
export function CustomerDataWithEmailSection({
  firstName,
  lastName,
  phone,
  email,
...
}: CustomerDataWithEmailSectionProps) {
  return (
    <section>
        ...
        {delivery === "shipping" && (
          <>
            ...
            <div className="p-4 rounded-2xl border bg-primary/5 border-primary/20 md:col-span-2">
              ...
              <Input
                placeholder="Ej: Cra 4 #12-34, Isnos, Huila"
                value={address}
            ...
            <div className="p-4 rounded-2xl border bg-black/5 dark:bg-white/5 border-black/10 dark:border-white/10 md:col-span-2">
              ...
              <Input
                placeholder="Ej: Entregar en Servientrega Isnos"
